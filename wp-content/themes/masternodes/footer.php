...
<section id="help" class="container">
    ...
    <h2>Help &amp; Support For Our Investors</h2>
    <div class="row">

        <div class="col-lg-6 support-item mb-4 mb-lg-0">
            <a href="https://t.me/en_2masternodes" target="_blank">
                <div class="logo">
                    <img src="https://2masternodes.com/img/telegram.svg">
                </div>
        ...
        <div class="col-lg-6 support-item">
            <a href="https://2masternodes.zendesk.com/hc/en-us" target="_blank">
                <div class="logo">
                    <img src="https://2masternodes.com/img/zendesk.svg">
                </div>
                <div class="description">
                    <div class="col-md-6 col-lg-12 p-0">
...
<footer id="main-footer">
    <div class="container">
        <div class="row">
            <div class="mb-4 mb-md-0 text-center text-md-left col-md-auto col-xl-4">
                © 2018 2Masternodes. All Rights Reserved.
            </div>
            <div class="mb-4 mb-md-0 text-center text-md-left col-md-auto col-xl-4 social-links">
