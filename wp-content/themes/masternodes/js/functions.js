...
( function( $ ) {
	...
	( function() {
		...
		button.on( 'click.masternodes', function() {
	...
	$( document ).ready( function() {
		...
		$window
			.on( 'scroll.masternodes', scroll )
			.on( 'load.masternodes', onResizeARIA )
			.on( 'resize.masternodes', function() {
				clearTimeout( resizeTimer );
				resizeTimer = setTimeout( resizeAndScroll, 500 );
				onResizeARIA();
			} );
		$sidebar.on( 'click.masternodes keydown.masternodes', 'button', resizeAndScroll );
